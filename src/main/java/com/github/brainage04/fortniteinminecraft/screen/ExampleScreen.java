package com.github.brainage04.fortniteinminecraft.screen;
...
public class ExampleScreen extends Screen {
    ...
    @Override
    protected void init() {
        button = ButtonWidget.builder(Text.literal("Button"), button -> FortniteInMinecraft.LOGGER.info("You clicked a button!"))
