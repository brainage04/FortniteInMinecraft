...
public final class ClientGameTestFeedbackHud {
    public static final String ENABLED_PROPERTY = "fortniteinminecraft.clientGameTest";
    private static final String GAME_TEST_MOD_ID = FortniteInMinecraft.MOD_ID + "-gametest";
    private static final Identifier HUD_ID = Identifier.fromNamespaceAndPath(FortniteInMinecraft.MOD_ID, "gametest_feedback");
    ...
    private ClientGameTestFeedbackHud() {
    }
    ...
    public static void initialize() {
        ...
        HudElementRegistry.attachElementBefore(VanillaHudElements.SCOREBOARD, HUD_ID, ClientGameTestFeedbackHud::render);
        registered = true;
    }
    ...
    public static boolean isEnabledForEnvironment() {
        return Boolean.getBoolean(ENABLED_PROPERTY) && FabricLoader.getInstance().isModLoaded(GAME_TEST_MOD_ID);
    }
    ...
    private static void render(GuiGraphicsExtractor graphics, net.minecraft.client.DeltaTracker deltaTracker) {
        ...
        if (client.player == null || client.gui.hud.isHidden() || !isEnabledForEnvironment()) {
            return;
        }
    ...
    private static List<HudLine> lines() {
        ...
        lines.add(new HudLine("GameTest Feedback", HEADER_COLOR));
    ...
    public static String pieceLabel(Enum<?> value) {
        return label(value);
    }
